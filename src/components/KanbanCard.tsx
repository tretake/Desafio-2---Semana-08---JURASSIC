    ...
    p-3 w-[278px]  rounded-3xl }`} >
      ...
      <div className='my-4'>
        ...
        <div className="w-full bg-[#E2E8F0] rounded-full h-2 ">
            <div className= { ` bg-[${getColor("item")}] h-2 rounded-full  `}  style={{width: `${percentage}%` }}></div>
        </div>
      </div>
      ...
      <div className='flex justify-between items-center'>
        <div className='flex text-[4.9px] md:text-[4.9px] lg:text-sm font-extrabold  '>
            <img className='rounded-full border-2 border-white border-box  w-8 translate-x-[-0]   ' src="./images/profile_picture.jpg" alt="" />
            <img className='rounded-full border-2 border-white border-box  w-8 translate-x-[-10px] ' src="./images/profile_picture.jpg" alt="" />
            <img className='rounded-full border-2 border-white border-box  w-8 translate-x-[-20px]' src="./images/profile_picture.jpg" alt="" />
            <img className='rounded-full border-2 border-white border-box  w-8 translate-x-[-30px]' src="./images/profile_picture.jpg" alt="" />
            <div className={ `text-[${getColor("item")}] bg-[${getColor('bg')}]   p-2  rounded-full border-2 border-white border-box   w-8 h-8 translate-x-[-40px]   flex items-center justify-center text-sm   `} >+3</div>
        </div>
        <div className='flex items-center'>

          <svg xmlns="http://www.w3.org/2000/svg" width="7" height="6" className='size-5' viewBox="0 0 7 6" fill="none">
