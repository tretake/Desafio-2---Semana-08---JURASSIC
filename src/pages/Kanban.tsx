  ...
  */
  ...
  return (
    ...
    >
      ...
      <button  onClick={ toggleActive}   className='bg-[#94A3B8] flex justify-center items-center rounded-full absolute top-[0px] right-0  z-30 size-9 md:size-11 lg:size- text-center '  > <svg xmlns="http://www.w3.org/2000/svg" width="12" height="20" viewBox="0 0 12 20" fill="none">
<path d="M10 10V2H11V0H1V2H2V10L0 12V14H5.2V20H6.8V14H12V12L10 10Z" fill="white"/>
      ...
      <div className={`absolute font-bold top-[0px] px-[18px] py-[23.26px] w-[247.59px] rounded-[25px] right-0 bg-[#6C7D96] z-20 ${ (isActive) ? 'hidden' :'' }  `} >
  
        <div>
          <h1 className='text-base text-white font-bold pb-[10px]' >In this project</h1>
          <ul  className='flex flex-col gap-[8.31px]'>
            <li className='flex px-[7.48px] pt-[5px]  gap-[8.52px] bg-[#F6F6F6E5] h-[45.7px] rounded-[12.46px]' >
              <img className='size-[36.56px] rounded-full ' src="./images/profile_picture.jpg" alt="" />
              <div >
                <h1 className='text-sm'>John Doe</h1>
                <h2 className='text-xs text-[#160A60]' >Project Manager</h2>
              </div>
            </li>
            <li className='flex px-[7.48px] pt-[5px] gap-[8.52px] bg-[#F6F6F6E5] h-[45.7px]  rounded-[12.46px]'>
              <img className='size-[36.56px] rounded-full ' src="./images/profile_picture.jpg" alt="" />
        ...
        <div className='' >
          <h1 className='text-base text-white' >Metrics</h1>
          <div className='flex gap-2 flex-wrap  flex-col justify-start h-[180px]' >
            <div className='w-[122px] h-[95px]  py-[3px]  text-xs text-[#160A60] px-2 rounded-[12.45px] bg-[#F6F6F6E5]' >
              <h1 className='text-[#160A60] ' >Total tasks</h1>
              <div className='flex items-center h-[21px] gap-[2.49px]' ><h1 className='text-xl text-[#4F46E5]' >10</h1> <p>To do</p></div>
              <div className='flex items-center h-[21px] gap-[2.49px]' ><h1 className='text-xl text-[#F59E0B]' >15</h1> <p>In progress</p></div>
              <div className='flex items-center h-[21px] gap-[2.49px]'><h1 className='text-xl text-[#22C55E]' >12</h1> <p >Done</p></div>
            </div>
            <div className='w-[122px] h-[63px] pt-[4px] rounded-[12.45px] bg-[#F6F6F6E5]' >
            ...
            <div  className='w-[90.56px] h-[166px] p-1 rounded-[12.45px] bg-[#F6F6F6E5] ' >
              <div>
            ...
            <li className='flex justify-center py-[5px] items-center rounded-[10px] bg-white'>
              <img className='size-[26.84px] rounded-full ' src="./images/profile_picture.jpg" alt="" />
              <div>
                <h1 className=' text-[10px]'>John Doe</h1>
                <h2 className=' text-[4px]' >Project Manager</h2>
              </div>
            </li>
            <li className='flex justify-center py-[5px] items-center rounded-[10px] bg-white'>
              <img className='size-[26.84px] rounded-full ' src="./images/profile_picture.jpg" alt="" />
